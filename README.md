<img src="https://i.ibb.co/93mSYZ4/decay.png" alt="decay.dev" width="256"/><img src="https://i.ibb.co/zbkjYkV/loot.png" alt="decay.dev/loot" width="256"/>
...
- If you use `scrap_range`, and a max items of `1`, scrap will always take precedence as the single regardless of the items added to the table.
- Users are unlikely to hit this edge case but if you choose a guaranteed scrap range, and choose to add an additional scrap resource to the crate, all scrap will be stacked.
